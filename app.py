...
def load_word_list():
    ...
    common_words = set([
        ...
        'lesbian', 'wrath', 'row', 'deevaluation', 'reevaluation', 'evaluation', 'reeducation', 'educational', 'retry', 'ban', 'deevaluate', 'reeducate', 'reevaluate', 'evaluate', 'educate', 'educator', 'car', 'israel', 'israeli', 'israelis', 'putin', 'vladimir', 'russia', 'russian', 'russians'
    ])
